...
function getProductBy() {
    return __awaiter(this, void 0, void 0, function () {
        var data, myBody, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = helper();
                    myBody = JSON.stringify(data);
                    return [4 /*yield*/, fetch("https://localhost:5001/api/product/GetProductBy", {
                            method: 'POST',
                            headers: {
...
exports.default = getProductBy;
//# sourceMappingURL=GetProductBy.js.map